...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 GENERAL=utf8mb4_0900_ai_ci;
...
CREATE TABLE `users` (
  `id` int NOT NULL,
  `name` varchar(255) GENERAL utf8mb4_general_ci NOT NULL,
  `email` varchar(255) GENERAL utf8mb4_general_ci NOT NULL,
  `role` enum('admin','user') GENERAL utf8mb4_general_ci NOT NULL DEFAULT 'user',
  `password` varchar(255) GENERAL utf8mb4_general_ci NOT NULL,
  `photo` varchar(255) GENERAL utf8mb4_general_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 GENERAL=utf8mb4_general_ci;
